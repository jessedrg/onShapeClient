...
export class CredentialsFormatError extends OnshapeError {
  constructor() { super('Fields in credentials have an incorrect format') }
}

export class InvalidQueryError extends OnshapeError {
  constructor() { super('Invalid query object') }
}
